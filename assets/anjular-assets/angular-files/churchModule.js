...
mainApp.directive('startdatetimeweeklyvideo', function(){
  return {
    require: 'ngModel',
    restrict: 'A',
    link: function(scope, element, attrs){ 
       ...
       // autoClose:1,
        ...
        widgetPositioning: {
          ...
          vertical: 'bottom'
			...
			$('#'+thisId).val(modstr);
			scope.weeklyVideoData.start_time=modstr;
		});
...
mainApp.directive('enddatetimeweeklyvideo', function(){
  return {
    require: 'ngModel',
    restrict: 'A',
    link: function(scope, element, attrs){ 
       ...
       // autoClose:1,
        ...
        widgetPositioning: {
          ...
          vertical: 'bottom'
			...
			$('#'+thisId).val(modstr);
			scope.weeklyVideoData.end_time=modstr;
		});
