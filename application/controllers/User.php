...
class User extends CI_Controller
{
    ...
    public function ajaxsetauthenticator()
	{
		$returnData=array();
	...
	public function ajaxsubmitotp()
	{
		...
		if(!empty(trim($email)) && !empty(trim($password)))
		{
			...
			if(count($userLoginData))
			{
				...
				$secret = $userLoginData['authenticator_secret'];
				$otp = $submittedOtp ;//Generated by Authenticator.
			...
			{
				$returnData['status']='0';
				$returnData['msg']='Login Credential is invalid!';
				$returnData['data']=array();
			}
		}
		else
