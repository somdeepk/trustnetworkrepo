                    ...
                    <table class="table table-striped table-bordered nowrap" width="98%" id="datatableChurchList">
                        ...
                        <thead>
                            <tr class="zsearcherz">
                                ...
                                <td align="left" >
                                    <input type="text" ng-model="searchChurch.Name" maxlength="25" class="zsearch_inputz form-control" placeholder="Search">
                                </td>
                                <td align="left" >
                                    <input type="text" ng-model="searchChurch.Type" maxlength="25" class="zsearch_inputz form-control" placeholder="Search">
                                </td>
                                <td align="left" >
                                    <input type="text" ng-model="searchChurch.CreateDate" maxlength="25" class="zsearch_inputz form-control" placeholder="Search">
                                </td>                                
                                <td align="left" >&nbsp;</td>
                            </tr>
                        </thead>
