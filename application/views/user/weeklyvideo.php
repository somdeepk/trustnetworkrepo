<div id="content-page" class="content-page" ng-controller="videoController" ng-init="initiateVideo(<?php echo $this->session->userdata('user_auto_id'); ?>,'<?php echo $this->session->userdata('parent_id'); ?>','<?php echo $this->session->userdata('membership_type'); ?>','<?php echo $this->session->userdata('is_admin'); ?>');">
  ...
  <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12" ng-show="session_is_admin=='Y'">               
           <div class="iq-card">
      ...
      <div class="row" ng-show="session_is_admin!='Y'" ng-repeat="(key, value) in allWeeklyVideoData" >
        ...
        <div class="col-sm-12">
           <div class="iq-card">
              <div class="iq-card-header d-flex justify-content-between">
                 <div class="iq-header-title">
                    <h4 class="card-title">{{value.video_title}} - [{{value.video_type}}]</h4> 
                 </div>
              </div>
           </div>
        </div>
        <div ng-repeat="(key1, value1) in value.resultFileData" class="col-md-4">
           <div class="iq-card">
                          ...
                          <div class="d-flex flex-wrap justify-content-between align-items-start">
                             <div class="profile-detail d-flex"> 
                                ...
                                <div class="col-sm-12 padding-lr0 mb10">
                                  <strong>Video {{parseInt(key1)+1}}</strong> 
                                    <video class="zminThreeVideoz" width="100%" height="200" controls>
                                      <source ng-src="{{value1.video_path_with_video}}">
                                    </video>                         
                                </div>
                                <!--/left-->
                             </div> 
      ...
      <div ng-show="session_is_admin!='Y'" class="row" ng-if="allWeeklyVideoData.length<=0" > 
        <div class="col-sm-12">               
          <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
               <div class="iq-header-title">
                  <h4 class="card-title">There is no Weekly Video</h4>
               </div> 
            </div>
          </div>
        </div>
