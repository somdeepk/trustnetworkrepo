<div id="content-page" class="content-page" ng-controller="profileController">
    <div class="container">
       <div class="row">
          <div class="col-lg-12">
             <div class="iq-card">
                               ...
                               <div class="form-group row align-items-center">
                                  <div class="col-md-12">
                                     <div class="profile-img-edit">
                                        <img class="profile-pic" src="<?php echo base_url();?>assets/images/user/11.png" alt="profile-pic">
                                        <div class="p-image">
